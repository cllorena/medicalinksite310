...
<table id="cart_summary" class="ttr_prochec_table_background col-xl-12 col-lg-12 std table">
	<colgroup>
		<col width="25%">
		<col width="12.5%">
		<col width="12.5%">
...
<tr class="ttr_prochec_row_1 row-1" style="vertical-align: top;">
	...
	<td class="ttr_prochec_image_border prochec_img" data-title="<?php echo vmText::_ ('COM_VIRTUEMART_CART_NAME') ?>" >
	...
	<td class="prochec_des" style="text-align: left;" data-title="<?php echo vmText::_ ('COM_VIRTUEMART_CART_SKU') ?>">
	<p class="ttr_order_description">	
		<?php  echo $prow->product_sku ?>	
	</p>
	</td>
	<td class="ttr_prochec_price prochec_unit_price" data-title="<?php echo vmText::_ ('COM_VIRTUEMART_CART_PRICE') ?>">
		<?php
	...
	<td class="ttr_prochec_price prochec_quant" data-title="<?php echo vmText::_ ('COM_VIRTUEMART_CART_QUANTITY') ?>"><?php
		   ...
		   <input type="text"
				   ...
				   title="<?php echo  vmText::_('COM_VIRTUEMART_CART_UPDATE') ?>" size="3" maxlength="4" name="quantity[<?php echo $pkey; ?>]" value="<?php echo $prow->quantity ?>" />
				   <span>
				   ...
				   <img alt="refresh" src="<?php echo $template_path?>/images/refresh.png"/>
				   </button>
				   ...
				   <img alt="remove" src="<?php echo $template_path?>/images/remove.png"/>
				   </button>
				   </span>
			</td>

	<?php if (VmConfig::get ('show_tax')) { ?>
	<td class="ttr_prochec_price prochec_tax" data-title="<?php echo vmText::_ ('COM_VIRTUEMART_CART_SUBTOTAL_TAX_AMOUNT') ?>"><?php echo $this->currencyDisplay->createPriceDiv ('taxAmount', '', $prow->prices, FALSE, FALSE, $prow->quantity, false, true) ?></td>
	<?php } ?>
	<td class="ttr_prochec_price prochec_discount" data-title="<?php echo vmText::_ ('COM_VIRTUEMART_CART_SUBTOTAL_DISCOUNT_AMOUNT')?>"><?php echo $this->currencyDisplay->createPriceDiv ('discountAmount', '', $prow->prices, FALSE, FALSE, $prow->quantity, false, true) ?></td>
	<td class="ttr_prochec_price prochec_total" data-title="<?php echo vmText::_ ('COM_VIRTUEMART_CART_TOTAL') ?>">
...
<tr class="row-2 responsive-price-detail" style="vertical-align:top;">
	...
	<?php if (VmConfig::get ('show_tax')) { ?>
	<td class="ttr_prochec_price shipment-payment" data-title="<?php echo vmText::_ ('COM_VIRTUEMART_CART_SUBTOTAL_TAX_AMOUNT') ?>"><?php
	...
	<?php } ?>
	<td class="ttr_prochec_price shipment-payment" data-title="<?php echo vmText::_ ('COM_VIRTUEMART_CART_SUBTOTAL_DISCOUNT_AMOUNT')?>"><?php if($this->cart->cartPrices['salesPriceShipment'] < 0) echo $this->currencyDisplay->createPriceDiv ('salesPriceShipment', '', $this->cart->cartPrices['salesPriceShipment'], FALSE); ?></td>
	<td class="ttr_prochec_price shipment-payment" data-title="<?php echo vmText::_ ('COM_VIRTUEMART_PRODUCT_TAX_AMOUNT_TT') ?>"><?php echo $this->currencyDisplay->createPriceDiv ('salesPriceShipment', '', $this->cart->cartPrices['salesPriceShipment'], FALSE); ?> </td>
</tr>
<?php } ?>
...
<tr class="row-2 responsive-price-detail" style="vertical-align:top;">
	...
	<?php } ?>
	<?php if (VmConfig::get ('show_tax')) { ?>
	<td class="ttr_prochec_price  shipment-payment" data-title="<?php echo vmText::_ ('COM_VIRTUEMART_CART_SUBTOTAL_TAX_AMOUNT') ?>"><?php echo $this->currencyDisplay->createPriceDiv ('paymentTax', '', $this->cart->cartPrices['paymentTax'], FALSE) ; ?> </td>
	<?php } ?>
	<td class="ttr_prochec_price shipment-payment" data-title="<?php echo vmText::_ ('COM_VIRTUEMART_CART_SUBTOTAL_DISCOUNT_AMOUNT')?>"><?php if($this->cart->cartPrices['salesPricePayment'] < 0) echo $this->currencyDisplay->createPriceDiv ('salesPricePayment', '', $this->cart->cartPrices['salesPricePayment'], FALSE); ?></td>
	<td class="ttr_prochec_price  shipment-payment" data-title="<?php echo vmText::_ ('COM_VIRTUEMART_PRODUCT_TAX_AMOUNT_TT') ?>"><?php  echo $this->currencyDisplay->createPriceDiv ('salesPricePayment', '', $this->cart->cartPrices['salesPricePayment'], FALSE); ?> </td>
</tr>
<?php  } ?>
...
<tr class="row-2 responsive-price-detail">
	...
	<?php if (VmConfig::get ('show_tax')) { ?>
	<td class="ttr_prochec_price shipment-payment" data-title="<?php echo vmText::_ ('COM_VIRTUEMART_CART_SUBTOTAL_TAX_AMOUNT') ?>"><?php echo $this->currencyDisplay->createPriceDiv ('taxAmount', '', $this->cart->cartPrices, FALSE, false, true) ?></td>
	<?php } ?>
	<td class="ttr_prochec_price shipment-payment" data-title="<?php echo vmText::_ ('COM_VIRTUEMART_CART_SUBTOTAL_DISCOUNT_AMOUNT')?>"><?php echo $this->currencyDisplay->createPriceDiv ('discountAmount', '', $this->cart->cartPrices, FALSE) ?></td>
	<td class="ttr_prochec_price shipment-payment" data-title="<?php echo vmText::_ ('COM_VIRTUEMART_PRODUCT_TAX_AMOUNT_TT') ?>"><?php echo $this->currencyDisplay->createPriceDiv ('salesPrice', '', $this->cart->cartPrices, FALSE) ?></td>
</tr>
...
<tr class="row-2 responsive-row last">
	...
	<?php if (VmConfig::get ('show_tax')) { ?>
	<td class="ttr_prochec_total"  data-title="<?php echo vmText::_ ('COM_VIRTUEMART_PRODUCT_TAX_AMOUNT_TT') ?>"> <?php echo $this->currencyDisplay->createPriceDiv ('billTaxAmount', '', $this->cart->cartPrices['billTaxAmount'], FALSE) ?> </td>
	<?php } ?>
	<td class="ttr_prochec_total"  data-title="<?php echo vmText::_ ('COM_VIRTUEMART_PRODUCT_DISCOUNT_AMOUNT_TT') ?>"> <?php echo $this->currencyDisplay->createPriceDiv ('billDiscountAmount', '', $this->cart->cartPrices['billDiscountAmount'], FALSE) ?> </td>
	<td class="ttr_prochec_total" style="font-weight:bold;"  data-title="<?php echo vmText::_ ('COM_VIRTUEMART_CART_TOTAL') ?>"><?php echo $this->currencyDisplay->createPriceDiv ('billTotal', '', $this->cart->cartPrices['billTotal'], FALSE); ?></td>
</tr>
