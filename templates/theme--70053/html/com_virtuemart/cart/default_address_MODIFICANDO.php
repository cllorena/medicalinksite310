...
<div class="billto-shipto">
	<div class="row">
		<div class="ttr_cart_content col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 col-12">
			<div style="margin:5px 0;" class="ttr_prochec_product_title">
				<!-- clla <span class="vmicon vm2-billto-icon"></span> -->
				<?php //clla echo vmText::_ ('COM_VIRTUEMART_USER_FORM_BILLTO_LBL'); ?>			
			</div>
			...
			//	}
			unset($this->cart->BTaddress['fields']);
			var_export($this->cart->BTaddress['fields']);
			...
			<a class="forgotpassword <?php echo $this->pointAddress ?>" href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=user&task=editaddresscart&addrtype=BT', $this->useXHTML, $this->useSSL) ?>" rel="nofollow">
				<?php // clla echo vmText::_ ('COM_VIRTUEMART_USER_FORM_EDIT_BILLTO_LBL'); ?>
			</a>

			<input type="hidden" name="billto" value="<?php echo $this->cart->lists['billTo']; ?>"/>
		</div>

		<div class="ttr_cart_content col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 col-12" style="float: right;">

			<div style="padding: 5px;" class="ttr_prochec_product_title">
			<!-- <span class="vmicon vm2-shipto-icon"></span> -->
				<?php //clla echo vmText::_ ('COM_VIRTUEMART_USER_FORM_SHIPTO_LBL'); ?>			
			</div>
			<?php // Output Bill To Address ?>
			<div class="output-shipto">
				...
				if($this->cart->user->virtuemart_user_id==0){
					...
					//clla echo vmText::_ ('COM_VIRTUEMART_USER_FORM_ST_SAME_AS_BT');
					//clla echo VmHtml::checkbox ('STsameAsBT', $this->cart->STsameAsBT,1,0,'id="STsameAsBTjs" data-dynamic-update=1') . '<br />';
			...
			<!--<a class="forgotpassword" href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=user&task=editaddresscart&addrtype=ST&virtuemart_user_id[]=' . $this->cart->lists['current_id'], $this->useXHTML, $this->useSSL) ?>" rel="nofollow" style="margin: 10px;">
				<?php //clla echo vmText::_ ('COM_VIRTUEMART_USER_FORM_ADD_SHIPTO_LBL'); ?>
			</a>-->
